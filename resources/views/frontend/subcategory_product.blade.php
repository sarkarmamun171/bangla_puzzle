                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-item">
                                <div class="image">
                                    <img src="{{ asset('uploads/product/preview/') }}/{{ $subcategory_product->preview_img }}" alt="" width="70">
                                    <div class="tag new">New</div>
                                </div>
                                <div class="text">
                                    <h2><a href="product-single.html">{{ $subcategory_product->product_name }}</a></h2>
                                    ...
                                    <div class="price">
                                        <span class="present-price">{{ $subcategory_product->after_discount }}</span>
                                        <del class="old-price">{{ $subcategory_product->price }}</del>
                                    </div>
                                    <div class="shop-btn">
